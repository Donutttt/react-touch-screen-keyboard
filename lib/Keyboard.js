...
var Keyboard = function (_PureComponent) {
  ...
  function Keyboard(props) {
    ...
    _this.handlePlusToggleClick = _this.handlePlusToggleClick.bind(_this);
  ...
  _createClass(Keyboard, [{
    ...
    key: 'handlePlusToggleClick',
    value: function handlePlusToggleClick() {
      var inputNode = this.props.inputNode;
      var value = inputNode.value;


      var nextValue = value[0] === '+' ? value.substring(1) : '+' + value;
              ...
              row.map(function (button, ii) {
                switch (button.toLowerCase()) {
                  ...
                  case '*pt':
                    return _react2.default.createElement(_KeyboardButton2.default, {
                      value: '+',
                      onClick: _this2.handlePlusToggleClick,
                      key: 'b' + ii
                    });
